...
const MONGODB_URI = 'mongodb+srv://chinmoy:666@cluster0.yfyovpw.mongodb.net/deerfit?retryWrites=true&w=majority&appName=Cluster0';

console.log('\n🔄 DeerFit Database Seeding (Direct Connection)\n');
...
async function seedDatabase() {
  try {
    ...
    if (error.message.includes('ECONNREFUSED')) {
      console.log('📌 Connection Issue: MongoDB Atlas is unreachable');
      console.log('   • Check internet connection');
      console.log('   • Verify cluster is running');
      console.log('   • Check IP whitelist\n');
    }
